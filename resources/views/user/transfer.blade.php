                ...
                <div class="card-body">
                    <div class="row profile">
                        <div class="p-2 col-md-12">
                            <div class="p-1 pb-3 shadow-lg card p-md-5 pb-md-0 ">
                                <div class="row">
                                    <div class="mb-3 col-md-4 offset-md-4">
                                        <div class="p-3 shadow card">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h5 class="mb-1 d-inlne"><b>{{$settings->currency}}{{ number_format(Auth::user()->account_bal, 2, '.', ',')}}</b></h5>
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form method="post" action="javascript:void(0)" id="transferform">
                                            ...
                                            <div class="form-group">
                                                <label for="" class="">Recipient Email or username <span class=" text-danger">*</span></label>
                                                <input type="text" name="email" class="form-control " required>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="">Amount({{ $settings->currency }}) <span class=" text-danger">*</span></label>
                                                <input type="number" min="{{$moresettings->min_transfer}}" name="amount" placeholder="Enter amount you want to transfer to recipient" class="form-control " required>
                                            </div>
                                            <div class="form-group">
                                                <h6  class="">Transfer Charges: <strong class=" text-danger">{{$moresettings->transfer_charges}}%</strong></h6>
                                            </div>
