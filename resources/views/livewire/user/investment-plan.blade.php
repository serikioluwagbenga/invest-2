                    ...
                    <div class="card-body">
                        ...
                        <div class="select-menu2">
                            <ul class="options2 d-block">
                                <li class="mb-3 shadow option2 {{ $paymentMethod == 'Account Balance' ? 'bg-light border border-primary' : '' }}"
                                    id="acnt" wire:click="chanegePaymentMethod('Account Balance')">
                                    <i class="fas fa-wallet"></i>
                                    <span class="option-text2 d-block">Account Balance </span> <br>
                                    <span class="small">
                                        <strong> Balance:
                                        </strong>{{ $settings->currency }}{{ number_format(Auth::user()->account_bal) }}
                                    </span>
                                </li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <span
                                    class="text-primary small">{{ $planSelected ? $planSelected->name : '-' }}</span>
                            </div>
                            <div class="mb-3 col-md-6">
