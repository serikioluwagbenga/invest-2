            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-7">
                    <div class="mt-4 title-heading">
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{url('/login')}}" class="pt-3 pb-3 pl-4 pr-4 btn btn-outline">
                                Login
                            </a>
                        </div>
                    </div>
                ...
                <div class="pt-2 mt-4 col-lg-6 col-md-5 mt-sm-0 pt-sm-0">
                    <div class="position-relative">
                        <img src="{{ asset('storage/app/public/'.$content->getImage('b9158B','img_path'))}}" class="mx-auto roundedd img-fluid d-block"
                            alt="">
                    </div>
                </div>
                <!--end col-->
                    ...
                    <div id="single-owl" class="owl-carousel owl-theme">
                        ...
                        <div class="m-2 overflow-hidden border-0 card roundedd">
                            <div class="row align-items-center no-gutters">
                                <div class="col-md-5">
                                    <img src="{{ asset('storage/app/public/'.$testimony->picture)}}" class="img-fluid w-75"
                                        alt="">
                                </div>
                                <!--end col-->
