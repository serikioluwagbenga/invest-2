                                ...
                                <form role="form" method="post" action="{{ route('addplan') }}">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <small class="text-{{$text}}">This is the maximum amount a user can pay to invest in this plan, enter the value without a comma(,)</small>
                                       </div>	
                                       <div class="form-group col-md-6">
                                            <h5 class="text-{{$text}}">Plan Minimum Price ({{$settings->currency}})</h5> 			 
                                             ...
                                             <small class="text-{{$text}}">This is the minimum amount a user can pay to invest in this plan, enter the value without a comma(,)</small> 
                                       </div>
                                       <div class="form-group col-md-6">
                                            ...
                                            <small class="text-{{$text}}">Same as plan price, enter the value without a comma(,)</small> 
                                       </div>
                                       <div class="form-group col-md-6">
                                           ...
                                           <small class="text-{{$text}}">This is the minimum return (ROI) for this plan, enter the value without a comma(,)</small>
                                       </div>
                                       <div class="form-group col-md-6">
                                           ...
                                           <small class="text-{{$text}}">This is the Maximum return (ROI) for this plan, enter the value without a comma(,)</small> 
                                       </div>
                                       <div class="form-group col-md-6">
                                           ...
                                           <small class="text-{{$text}}">Optional Bonus if a user buys this plan.enter the value without a comma(,) </small>  
                                       </div>
                                       <div class="form-group col-md-6">
