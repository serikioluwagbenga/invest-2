        ...
        <form action="javascript:void(0)" method="POST" id="emailform">
            ...
            <div class=" form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <small class="text-{{$text}}">Set this to your Valid OAuth Redirect URI in console.cloud.google.com. Be sure to replace the 'yoursite.com' with your website url  </small>
                </div>
            </div>
