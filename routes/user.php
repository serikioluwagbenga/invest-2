...
use App\Http\Controllers\User\P2pUserController;
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function(){
	...
	// p2p route urls
	Route::get('p2p-window', [ViewsController::class, 'showWindow'])->name('p2pwindow');
	Route::get('transact/{id}', [ViewsController::class, 'transact'])->name('transact');
	Route::get('order-payment/{order}', [ViewsController::class, 'payForOrder'])->name('payorder');
});
