            ...
            <div class="row justify-content-center">
                <div class="text-center col-lg-12">
                    <div class="page-next-level">
                        <h4 class="title"><?php echo e($content->getContent('anvs8c','title')); ?></h4>
                        <div class="page-next">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="pt-2 mt-4 col-lg-5 col-md-5 mt-sm-0 pt-sm-0">
                    <div class="position-relative">
                        <img src="<?php echo e(asset('storage/app/public/'.$content->getImage('iAwfKe','img_path'))); ?>" class="mx-auto rounded img-fluid d-block"
                            alt="">
                        <div class="play-icon">
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="pb-2 mb-4 text-center section-title">
                        <h6 class="text-primary"><?php echo e($content->getContent('5hbB6X','title')); ?></h6>
                        <h4 class="mb-4 title"><?php echo e($content->getContent('5hbB6X','description')); ?></h4>
            ...
            <div class="row">
                <div class="pt-2 mt-4 col-md-4">
                    <div
                        ...
                        <div class="card-body">
                            <h5 class="text-dark"><?php echo e($content->getContent('Zrhm3I','title')); ?></h5>
                            <p class="mb-0 text-muted"><?php echo e($content->getContent('Zrhm3I','description')); ?></p>
                        </div>
                    </div>
                </div>
                <!--end col-->
                ...
                <div class="pt-2 mt-4 col-md-4 mt-md-5 pt-md-3">
                    <div
                        ...
                        <div class="card-body">
                            <h5 class="text-dark"><?php echo e($content->getContent('yTKhlt','title')); ?></h5>
                            <p class="mb-0 text-muted"><?php echo e($content->getContent('yTKhlt','description')); ?></p>
                        </div>
                    </div>
                </div>
                <!--end col-->
                ...
                <div class="pt-2 mt-4 col-md-4 mt-md-5 pt-md-5">
                    <div
                        ...
                        <div class="card-body">
                            <h5 class="text-dark"><?php echo e($content->getContent('u0Ervr','title')); ?></h5>
                            <p class="mb-0 text-muted"><?php echo e($content->getContent('u0Ervr','description')); ?></p>
                        </div>
                    </div>
                </div>
                <!--end col-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/home/about.blade.php ENDPATH**/ ?>