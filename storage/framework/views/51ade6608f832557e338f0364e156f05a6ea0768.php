...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm ">
            <h2 class="text<?php echo e($text); ?>"><?php echo e(__('Browser Sessions')); ?></h2>
                            ...
                            <div>
                                <div class="">
                                    ...
                                    <?php if($session->is_current_device): ?>
                                        <span class="text-success"><?php echo e(__('This device')); ?></span>
                                    <?php else: ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingLogout']); ?>
             <?php $__env->slot('title', null, []); ?> 
                <h3 class=""><?php echo e(__('Log Out Other Browser Sessions')); ?></h3>
                
             <?php $__env->endSlot(); ?>

             <?php $__env->slot('content', null, []); ?> 
                <p class=""><?php echo e(__('Please enter your password to confirm you would like to log out of your other browser sessions across all of your devices.')); ?></p>
                

                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['type' => 'password','class' => 'd-block form-control ','placeholder' => ''.e(__('Password')).'','xRef' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'password','class' => 'd-block form-control ','placeholder' => ''.e(__('Password')).'','x-ref' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>