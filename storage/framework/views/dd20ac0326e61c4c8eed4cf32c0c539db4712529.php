                                            ...
                                            <a style="cursor: pointer;" data-method="<?php echo e($method->name); ?>"
                                                ...
                                                <div class="rounded shadow ">
                                                    <div
                                                        ...
                                                        <span>
                                                            <input type="checkbox" id="<?php echo e($method->id); ?>customCheck1"
                                                                readonly>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <?php $__currentLoopData = $deposited; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposited): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(!empty($deposited->count)): ?>
                                                        <h6 class="mb-1">
                                                            <b><?php echo e($settings->currency); ?><?php echo e(number_format($deposited->count, 2, '.', ',')); ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/user/deposits.blade.php ENDPATH**/ ?>