                            ...
                            <div class="p-4 row">
                                <div class="col-md-8 offset-md-2">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input type="text" class="form-control readonly " value="<?php echo e(Auth::user()->ref_link); ?>" id="reflink" readonly>
                                    ...
                                    <h4 class="text-success"> <?php echo e(Auth::user()->username); ?></h4> <br>
                                    <h3 class="title1">
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/user/referuser.blade.php ENDPATH**/ ?>