                                ...
                                <?php if($title != 'Complete Payment'): ?>
                                    ...
                                    <div>
                                        <h6 class="">You are to make payment of
                                            <strong><?php echo e($settings->currency); ?><?php echo e(number_format($amount)); ?></strong> using
                                            ...
                                            <div class="mb-3 form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control readonly "
                                                        value="<?php echo e($payment_mode->wallet_address); ?>" id="reflink"
                                                        readonly>
                                            ...
                                            <?php else: ?>
                                                <?php if(!empty($payment_mode->bankname)): ?>
                                                    ...
                                                    <div class="mb-3 input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn btn-outline-secondary"
                                                                onclick="myFunction()" type="button" id="button-addon2"
                                                                disabled><i class="fas fa-copy"></i></button>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(!empty($payment_mode->account_name)): ?>
                                        ...
                                        <div>
                                            <form method="post" action="<?php echo e(route('savedeposit')); ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="proof" class="form-control col-lg-8 "
                                                        required>
                                                </div>
                                                <input type="hidden" name="amount" value="<?php echo e($amount); ?>">
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/user/payment.blade.php ENDPATH**/ ?>