                            ...
                            <form method="POST" action="<?php echo e(route('verification.send')); ?>"  class="mt-4 login-form">
                                 <?php echo csrf_field(); ?>
                                    ...
                                    <div class="mb-0 col-lg-12">
                                        <button class="btn btn-primary btn-block pad" type="submit"> <?php echo e(__('Resend Verification Email')); ?></button>
                                    </div>
                                    <!--end col-->
                                </div>
                                <!--end row-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/auth/verify-email.blade.php ENDPATH**/ ?>