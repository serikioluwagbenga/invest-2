...
<?php if (! $__env->hasRenderedOnce('5309840e-0f8f-46df-9da1-7346070e274d')): $__env->markAsRenderedOnce('5309840e-0f8f-46df-9da1-7346070e274d'); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingPassword']); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        ...
        <div class="mt-4 border-none" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['type' => 'password','class' => 'form-control ','placeholder' => ''.e(__('Password')).'','xRef' => 'confirmable_password','wire:model.defer' => 'confirmablePassword','wire:keydown.enter' => 'confirmPassword']]); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/vendor/jetstream/components/confirms-password.blade.php ENDPATH**/ ?>