                ...
                <a href="<?php echo e(route('manageusers')); ?>">
                    <form class="navbar-left navbar-form nav-search mr-md-3" action="javascript:void(0)">
                        <div class="input-group">
                            ...
                            <input type="text" placeholder="Manage users" class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>">
                        </div>
                    </form>
                </a>
                ...
                <li class="nav-item dropdown hidden-caret">
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(url('admin/dashboard/adminprofile')); ?>">Account Settings</a>
...
<?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/admin/topmenu.blade.php ENDPATH**/ ?>