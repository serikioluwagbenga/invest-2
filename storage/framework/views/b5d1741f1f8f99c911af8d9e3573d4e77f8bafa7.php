								...
								<div class="card-deck">
									<div class="text-center border-0 rounded-lg shadow-lg card card-pricing hover-scale-110 bg-primary popular">
										<div class="py-0 border-0 card-header">
											<span class="px-4 py-1 mx-auto bg-white shadow-sm h6 d-inline-block rounded-bottom"><?php echo e($method->name); ?></span>
											<div class="py-5">
												<img src="<?php echo e(asset('dash2/img/svg/illustrations/method.svg')); ?>" alt="withdrawal method image" srcset="" class="img-fluid img-center" style="height:90px;">
										...
										<div class="card-body">
											<ul class="mb-4 text-white list-unstyled">
												<li> 
													...
													<p class="text-white h5"><?php echo e($settings->currency); ?><?php echo e(number_format($method->minimum)); ?></p>
												</li>
												<li>
													<small>Maximum withdrawable amount</small>
													<p class="text-white h5"><?php echo e($settings->currency); ?><?php echo e(number_format($method->maximum )); ?></p>
												</li>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/therightchoice/public_html/app.thecexio.com/resources/views/user/withdrawals.blade.php ENDPATH**/ ?>